...
const Thriller = () => {
    ...
    const thrillermoviedata = async () => {
        const data = await axios.get("https://www.omdbapi.com/?apikey=33acb252&s=conjuring")
        setThrillerMovies(data.data.Search);
    }
